...
public class ex58_TestConsSuper {
	public static void main(String[] args) {
		...
		System.out.println("c1의 color="+c1.color+", CarSize="+c1.size+", door="+c1.door);
		System.out.println("c2의 color="+c2.color+", CarSize="+c2.size+", door="+c2.door);
		System.out.println("c3의 color="+c3.color+", CarSize="+c3.size+", door="+c3.door);
	}
}
